        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header bg-gradient-dark">
                    <h3>Petugas</h3>
                    <a href="" data-toggle="modal" data-target="#fPetugas" data-petugas="add" class="btn btn-secondary">Tambah Data</a>
                </div>
                <div class="card-body">
                    <table class="table table-boarder">
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $row['level'] ?></td>
                                <td>
                                    <a href="" data-toggle="modal" data-target="#fPetugas" class="btn btn-primary" data-petugas="<?= $data ?>">Edit</a>
                                    <a href="/petugas/delete/<?= $row['id_petugas'] ?>" onclick="return confirm('Yakin ingin hapus data ?')" class="btn btn-danger">Hapus</a>
                                </td>
                            </tr>
                        <?php
                        }
